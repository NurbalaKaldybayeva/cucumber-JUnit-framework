...
public class ProductInformationStepDefs {
	...
	@Then("correct default count and size should be displayed")
	public void correct_default_count_and_size_should_be_displayed() {
		ItemPage itemPage = new ItemPage();
	...
	public void the_user_should_be_able_to_toggle_the_count() {
	  ...
	  public void the_price_should_be(String string) {
	      String actualPrice= new ItemPage().price.getText();
	      assertEquals(actualPrice,"");
	  }
